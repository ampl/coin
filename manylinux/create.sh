...
docker commit manylinux64_tmp fdabrandao/manylinux64:coin.v1
...
docker commit manylinux32_tmp fdabrandao/manylinux32:coin.v1
docker rm manylinux32_tmp

# Upload images:
# $ docker login --username=fdabrandao
# $ docker push fdabrandao/manylinux32:coin.v1
# $ docker push fdabrandao/manylinux64:coin.v1
